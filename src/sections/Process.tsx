...
export function Process() {
  ...
  return (
    <section id="process" className="py-24 bg-[#080F1E] relative overflow-hidden">
      {/* Декоративный фон */}
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
          ...
          {config.process.map((step) => {
            ...
            return (
              <div key={step.step} className="text-center">
                ...
                {/* Разделитель */}
                <div className="w-8 h-px bg-emerald-500/60 mx-auto mb-5" />
        ...
        <div className="mt-20 grid sm:grid-cols-3 gap-6">
          <div className="glass rounded-lg p-6 text-center">
            <p className="text-3xl font-serif font-bold text-orange-400 mb-2">100%</p>
            <p className="text-white/80">Соблюдение сроков</p>
          </div>
          <div className="glass rounded-lg p-6 text-center">
            <p className="text-3xl font-serif font-bold text-orange-400 mb-2">0 ₽</p>
            <p className="text-white/80">Выезд и замер в Иркутске</p>
          </div>
          <div className="glass rounded-lg p-6 text-center">
            <p className="text-3xl font-serif font-bold text-orange-400 mb-2">2 года</p>
