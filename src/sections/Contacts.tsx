...
export function Contacts() {
  ...
  return (
    <section id="contacts" className="py-24 bg-[#080F1E]">
      <div className="container mx-auto px-4 lg:px-8">
              ...
              <div className="space-y-6">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-white text-lg font-medium group-hover:text-emerald-400 transition-colors">
              ...
              <div className="flex gap-4">
                {config.social.instagram && (
                  <a
                    ...
                    className="w-12 h-12 rounded-full bg-white/10 flex items-center justify-center hover:bg-emerald-500/20 transition-colors"
                  >
        ...
        {/* Карта */}
        <div className="mt-12 rounded-xl overflow-hidden h-80 bg-[#0F2035]">
          <iframe
